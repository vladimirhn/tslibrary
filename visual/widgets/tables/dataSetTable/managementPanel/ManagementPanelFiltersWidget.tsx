...
interface properties {
    ...
    filterVisibilityState:BooleanState
}

export const ManagementPanelFiltersWidget: FunctionComponent<properties> = ({ repository, filterVisibilityState }) => {
    ...
    const applyFilterButton = <Button
        onClick={() => {repository.fetchFiltered(exampleObjectState.getDataObject()); filterVisibilityState.toggleValue()}}
